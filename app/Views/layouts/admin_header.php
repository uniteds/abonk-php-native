    ...
    <div class="admin-container">
        ...
        <aside>
            ...
            <div class="user-badge">
                <span class="username"><?= \App\Core\Request::escape(\App\Core\Session::get('user_username')) ?></span>
                <span class="role"><?= \App\Core\Session::get('user_role') ?></span>
                <a href="<?= BASE_URL ?>" class="logout-link" style="color: var(--color-accent); margin-top: 5px;">Kunjungi Situs</a>
                <a href="<?= BASE_URL ?>/admin/logout" class="logout-link">Keluar Sesi</a>
            </div>
        </aside>
