...
<footer class="pt-50 pb-20 bg-grey">
    <div class="container">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="sidebar-widget wow fadeInUp animated mb-30">
                    ...
                    <div class="textwidget">
                        <p><?= \App\Core\Request::escape($settings['site_desc'] ?? 'Platform penerbitan digital modern menggunakan PHP Native OOP.') ?>
                        </p>
                        <p><strong class="color-black">Lokasi:</strong> Kota Padang, Indonesia</p>
                        <p><strong class="color-black">Surel:</strong> abonk@farouk.id</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-2 col-md-6">
                <div class="sidebar-widget widget_categories wow fadeInUp animated mb-30" data-wow-delay="0.1s">
                    ...
                    <ul class="font-small">
                        ...
                        <li class="cat-item cat-item-2"><a href="<?= BASE_URL ?>/page/tentang-kami">Tentang Kami</a>
                        </li>
                        ...
                        <?php if (!empty($categories)): ?>
                            <?php foreach (array_slice($categories, 0, 8) as $cat): ?>
                                <a class="tag-cloud-link"
                                    href="<?= BASE_URL ?>/category/<?= \App\Core\Request::escape($cat['slug']) ?>"><?= \App\Core\Request::escape($cat['name']) ?></a>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="sidebar-widget widget_newsletter wow fadeInUp animated mb-30" data-wow-delay="0.3s">
                    ...
                    <div class="newsletter">
                        <p class="font-medium">Dapatkan informasi artikel terbaru serta tips dan trik langsung ke kotak
                            masuk surel Anda.</p>
                        <form class="input-group form-subcriber mt-30 d-flex"
                            onsubmit="alert('Terima kasih telah mendaftar buletin!'); return false;">
                            <input type="email" class="form-control bg-white font-small"
                                placeholder="Masukkan surel Anda..." required>
        ...
        <div class="footer-copy-right pt-30 mt-20 wow fadeInUp animated">
            <p class="float-md-start font-small text-muted">© <?= date('Y') ?>,
                <?= \App\Core\Request::escape($settings['site_name'] ?? 'Abonk CMS') ?>. Hak Cipta Dilindungi. </p>
            <p class="float-md-end font-small text-muted">
                Dikembangkan dengan <span style="color: var(--color-accent); font-weight: 700;">PHP Native OOP &
                    MySQL</span> | Abonk CMS
            </p>
        </div>
    </div>
</footer>
